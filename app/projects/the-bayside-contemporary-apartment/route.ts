...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("projects-the-bayside-contemporary-apartment.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "projects-the-bayside-contemporary-apartment.html"), "utf8");
