...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("projects-minimalist-master-bedroom-suite.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "projects-minimalist-master-bedroom-suite.html"), "utf8");
