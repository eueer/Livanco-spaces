...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("projects-industrial-loft-open-living-area.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "projects-industrial-loft-open-living-area.html"), "utf8");
