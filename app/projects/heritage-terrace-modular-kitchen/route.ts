...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("projects-heritage-terrace-modular-kitchen.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "projects-heritage-terrace-modular-kitchen.html"), "utf8");
