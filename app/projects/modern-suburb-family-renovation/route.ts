...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("projects-modern-suburb-family-renovation.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "projects-modern-suburb-family-renovation.html"), "utf8");
