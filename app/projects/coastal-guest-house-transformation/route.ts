...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("projects-coastal-guest-house-transformation.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "projects-coastal-guest-house-transformation.html"), "utf8");
