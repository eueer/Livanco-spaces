...
/** The "/projects/the-bayside-contemporary-apartment" page, composed from its Framer sections.
 *
...
export default function ProjectsTheBaysideContemporaryApartmentPage() {
  return (
    <body>
      {"\n\t\n\t"}
