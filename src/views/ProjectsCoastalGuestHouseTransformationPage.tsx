...
/** The "/projects/coastal-guest-house-transformation" page, composed from its Framer sections.
 *
...
export default function ProjectsCoastalGuestHouseTransformationPage() {
  return (
    <body>
      {"\n\t\n\t"}
